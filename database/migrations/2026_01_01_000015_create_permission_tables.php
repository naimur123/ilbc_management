...
/**
 * Standard spatie/laravel-permission table set (Section 4/5 RBAC).
 * Column shapes match spatie/laravel-permission ^6.x exactly so the
 * package's models/traits work without any config changes.
 */
