        ...
        <div class="col-md-6">
            <div class="kpi-card h-100">
                ...
                <table class="table table-sm mb-0">
                    ...
                    <tr><th class="text-muted">Advance / Credit Days</th><td>{{ $request->salesEntry->advance_amount ?? 0 }} / {{ $request->salesEntry->credit_days ?? 0 }} days</td></tr>
        ...
        <table class="table table-sm mb-0">
            ...
            @foreach($request->items as $item)
                <tr>
                    ...
                    <td>{{ $item->commitmentType->name }}</td>
                    <td>{{ $item->billingType->name }}</td>
                    <td>{{ ($item->is_recurring == 1) ? 'Yes' : 'NO' }}</td>
                    <td>{{ $item->recurring_months }}</td>
                    <td>{{ $item->quantity }}</td>
