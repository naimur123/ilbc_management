@extends('layouts.app')
@section('title', 'Billing Types')
@section('content')
<div class="d-flex justify-content-between mb-3">
    <h4>Billing Types</h4>
    <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addModal"><i class="bi bi-plus-lg"></i> Add Billing Type</button>
</div>
<div class="kpi-card">
    <table class="table table-sm align-middle">
        ...
        <tr>
            ...
            <td class="text-end">
                ...
                <form action="{{ route('billing-types.destroy', $item) }}" method="POST" class="d-inline" onsubmit="return confirm('Delete?')">@csrf @method('DELETE')<button class="btn btn-sm btn-outline-danger"><i class="bi bi-trash"></i></button></form>
            </td>
        </tr>
        @endforeach
        </tbody>
...
<div class="modal fade" id="editModal{{ $item->id }}"><div class="modal-dialog"><div class="modal-content">
    <form action="{{ route('billing-types.update', $item) }}" method="POST">@csrf @method('PUT')
    <div class="modal-header"><h6 class="modal-title">Edit Billing Type</h6><button class="btn-close" data-bs-dismiss="modal"></button></div>
...
<div class="modal fade" id="addModal"><div class="modal-dialog"><div class="modal-content">
    <form action="{{ route('billing-types.store') }}" method="POST">@csrf
    <div class="modal-header"><h6 class="modal-title">Add Billing Type</h6><button class="btn-close" data-bs-dismiss="modal"></button></div>
